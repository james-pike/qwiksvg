...
export default component$(() => {
  return (
    <section class="relative md:-mt-[76px] not-prose">
      <script src="https://unpkg.com/@dotlottie/player-component@2.7.12/dist/dotlottie-player.mjs" type="module"></script><dotlottie-player src="https://lottie.host/f401db68-5f9c-45f3-9740-822266addeff/9dTNPA28ub.json" background="transparent" speed="1" style="width: 100%; height: 60%" direction="1" playMode="normal" loop autoplay></dotlottie-player>
