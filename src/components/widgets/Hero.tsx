...
export default component$(() => {
  return (
    <section class="relative md:-mt-[76px] not-prose">
      <script src="https://unpkg.com/@dotlottie/player-component@2.7.12/dist/dotlottie-player.mjs" type="module"></script><dotlottie-player src="https://lottie.host/31d07d4e-e255-4bfe-b875-3c165b58d6b0/YKqfIcJWuT.json" background="transparent" speed="1" style="width: 100%; height: 40vh" direction="1" playMode="normal" loop autoplay></dotlottie-player>
