...
export default component$(() => {
  ...
  return (
    ...
    class={`sticky top-0 z-40 flex-none w-full border-b border-gray-50/0 transition-[opacity] ease-in-out ${
      store.isScrolling
        ...
        : ""
    } p-2 rounded-lg shadow-md max-w-[calc(100%-1rem)] md:max-w-full overflow-hidden md:p-0 md:rounded-none md:shadow-none`}
    window:onScroll$={() => {
  ...
  >
    ...
    <div class="relative text-default py-3 px-3 md:px-6 w-full md:flex md:justify-between max-w-7xl mx-auto">
